    ...
    <el-row>
        ...
        <el-col :span="16" style="padding-left: 10px">
            ...
            <div class="graph">
                ...
                <el-card ref="pieCahrt" style="height: 260px"></el-card>
            </div>
        </el-col>
    </el-row>
</template>
...
export default {
    ...
    methods: {
        ...
        lineChart(orderData) {
            ...
            ecahrtsOption.xAxis = xAxisData
            ecahrtsOption.yAxis = {}
            ecahrtsOption.legend = xAxisData

            ecahrtsOption.series = []
            xAxis.forEach(key => {
                ecahrtsOption.series.push({
                    name: key,
            ...
            // 根据配置显示图表
            echarts1.setOption(ecahrtsOption);
        },
        // 柱状图
        barChart(userData) {
            const echartsOption = {
        ...
        pieChart(videoData) {
            ...
            // 基于准备好的dom，初始化echarts实例
            // 根据配置显示图表
            echarts.init(this.$refs.pieCahrt).setOption(echartsOption);
        }
    }
}
</script>
